...
impl IceLibrary {
    ...
    pub fn privatekey_to_publickey(&self, hex: &str) -> [u8; 33] {
        ...
        result[0] = if res[64] % 2 == 0 { 2 } else { 3 }; // Определение первого байта
        result[1..].copy_from_slice(&res[1..33]); // Копирование оставшихся байт
        result
